...
def voice_agent(fileName):
    ...
    chat_completion = groqClient.chat.completions.create(
        messages=[
            ...
            {
                "role": "user",
                "content": "Categorize this complaint: {0}".format(
                    response
                ),
            },
        ],
...
if __name__ == "__main__":
    # app.run(debug=True)
    # voice_agent("Text-to-Speech_18-Aug-2024_07-28.mp3")
    # text_agent("""I took out an auto loan with ABC Bank, and my monthly payments were set to be automatically deducted from my checking account. However, last month, the payment was not deducted, and I was charged a late fee of $50. I contacted the bank immediately to resolve the issue, but they insisted that I missed the payment, despite my bank statements clearly showing sufficient funds in my account. I requested a refund of the late fee, but the bank refused, stating that it was my responsibility to ensure the payment was made on time. I escalated the matter to a supervisor, who promised to investigate and get back to me within 48 hours, but I never heard back. Frustrated, I decided to cancel the auto-payment feature altogether and manually make the payment. Unfortunately, the bank charged me another late fee the following month, claiming that I had not made the payment on time, even though I had a confirmation number from their online banking system. I am now being harassed by collections, and my credit score has been negatively impacted due to these false reports. This issue has caused me significant stress and financial burden, and I want the late fees refunded, the negative credit report corrected, and compensation for the distress caused.""")
    image_agent("Screenshot (14).png")